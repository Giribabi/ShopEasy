            ...
            <div className="header">
                <div className="cart">
                    <div className="cart-quantity">
                        Items: {cartProducts.totalQuantity===undefined? 0: cartProducts.totalQuantity}
                    </div>
                    <Link to="/cart">
                    <img src={cart} alt="cart" className="cart-logo"/>
                    </Link>
                    <div className="cart-total">
                        Rs.{cartProducts.total===undefined? 0: cartProducts.total}
                    </div>
                </div>
                    ...
                    <div>
                        {
                            products.length===0
                            ?
                            <h2 className="no-products">Oops! No Products to display in the given price range</h2>
                            :
                        ...
                        onClick={()=>{
                            ...
                            setTitle(product.title)
                            setPid(product.id)
                            console.log("home-page-item selected")
                        }}>
                        <Item 
                        key={`${product.id}`}
                        itemId={product.id}
